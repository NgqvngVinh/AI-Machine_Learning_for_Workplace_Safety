...
if __name__ == "__main__":
    ...
    while(viewer.is_available() and (quit_app == False)):
        ...
        # 3D Bounding box and velocity
                        body_bounding_box_3d = body.bounding_box_3d
                        body_velocity = body.velocity

        # Example usage: Print 3D bounding box and velocity
            print(f"3D Bounding Box: {body_bounding_box_3d}, Velocity: {body_velocity}")

        # If you wish to render the 3D bounding box, you can pass it to your 3D viewer here
                # 3D rendering
            if update_3d_view:
