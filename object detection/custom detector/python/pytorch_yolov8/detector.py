...
#     parser = argparse.ArgumentParser()
#     # parser.add_argument('--weights', type=str, default='yolov8m.pt', help='model.pt path(s)')
#     parser.add_argument('--weights', type=str, default=r'C:\Program Files (x86)\ZED SDK\samples\object detection\custom detector\python\pytorch_yolov8\yolov8s_custom.pt', help='model.pt path(s)')
...
def torch_thread(weights, img_size, conf_thres=0.6, iou_thres=0.45):
    global image_net, exit_signal, run_signal, detections
